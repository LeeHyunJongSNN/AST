...
parser.add_argument("--ET", dest="encoder_type", default="PoissonEncoder")
...
parser.add_argument("--FS_input_num", type=int, default=64)
parser.add_argument("--FS_exc_num", type=int, default=1)
...
sorted_data = whole[whole[:, -1].argsort()]
